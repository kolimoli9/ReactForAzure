...
// 
  ...
  const deleteFlight =async (flight)=>{
     axios.delete(`https://tmw-sr.azurewebsites.net/flights/${flight.id}`,config).then((response)=>{alert(JSON.stringify(response.data))});
     refreshFlights();
};
  ...
  const updateFlight=async()=>{
    let data = JSON.stringify({
      ...
      tickets:tickets})
      axios.put(`https://tmw-sr.azurewebsites.net/flights/${flight.id}`,data,config).then((response)=>{
